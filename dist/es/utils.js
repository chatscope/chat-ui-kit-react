...
export var getChildren = function getChildren(children, types) {
  ...
  React.Children.toArray(children).forEach(function (item) {
    ...
    if (idx !== -1) {
      ...
      var is = (_item$props$as = item === null || item === void 0 || (_item$props = item.props) === null || _item$props === void 0 ? void 0 : _item$props.as) !== null && _item$props$as !== void 0 ? _item$props$as : item === null || item === void 0 || (_item$props2 = item.props) === null || _item$props2 === void 0 ? void 0 : _item$props2.is;
  ...
  return function (props, propName, componentName) {
    ...
    var forbidden = React.Children.toArray(props[propName]).find(function (item) {
      ...
      if (allowedTypes.indexOf(item.type) === -1) {
        ...
        var is = (item === null || item === void 0 || (_item$props3 = item.props) === null || _item$props3 === void 0 ? void 0 : _item$props3.as) || (item === null || item === void 0 || (_item$props4 = item.props) === null || _item$props4 === void 0 ? void 0 : _item$props4.is);
        var typeofIs = _typeof(is);
        if (typeofIs === "function") {
          // Type
